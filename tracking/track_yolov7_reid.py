...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap  in dataset:
        ...
        id_feature, pred = model(img, augment=opt.augment)
        ...
        # Apply Classifier
        if classify:
            pred = apply_classifier(pred[0], modelc, img, im0s)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            online_targets = tracker.update(detections, id_feature, im0)
    ...
    accs = []
    print('Evaluating')
    evaluator = Evaluator('/home/zhuguangxun/datasets/MOT17/train','MOT17-02-DPM',  'MOTChallenge') #/home/zhuguangxun/datasets/MOT17/train  MOTChallenge
